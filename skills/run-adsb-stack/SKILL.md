...
| Chat fails with a model-not-found style error | The id must match the endpoint exactly. Pointed straight at LM Studio, that is the **full** name (`google/gemma-4-12b-qat`); the bare name resolves only through the MLflow gateway. |
