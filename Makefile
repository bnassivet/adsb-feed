...
help:
	...
	@echo "  make feed-arm64 / feed-armv7 / server-arm64   one artifact each"
	@echo "  make deploy       ship them to a Pi         (delegated to rust/)"
	@echo "  make ci           the full local gate (tooling tests + rust/)"
	@echo "  make test-scripts just the shell/Python tooling tests"
	@echo ""
