"use client";
/**
 * The show/hide-on-map eye, shared by every list that can take a track off the
 * map — `AircraftTable` (per row and per section) and `SimulationPanel` (per
 * trajectory and per scenario).
 *
 * `data-icon` is load-bearing: tests assert on it rather than on the SVG paths.
 */
